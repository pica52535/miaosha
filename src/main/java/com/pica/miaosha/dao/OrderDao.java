...
public interface OrderDao {
    ...
    public MiaoshaoOrder getMiaoshaOrderByUserIdGoodsId(@Param("userId") Long userId, @Param("goodsId") long goodsId);
    ...
    int insertMiaoshaOrder(MiaoshaoOrder miaoshaoOrder);
